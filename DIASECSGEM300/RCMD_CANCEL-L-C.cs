...
{
    public class RCMD_CANCEL_L_C
    {
        public string LOADPORT_ID { get; set; }
        public string CARRIER_ID { get; set; }

        public RCMD_CANCEL_L_C()
        {
    ...
    {
        public bool RunDecode(RemoteControlEventRemoteCommandArgs e, out RCMD_CANCEL_L_C rcmdInfo)
        {
            bool bDataCheckOK = true;
            rcmdInfo = new RCMD_CANCEL_L_C();
