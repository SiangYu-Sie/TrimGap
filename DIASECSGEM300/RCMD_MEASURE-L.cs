...
{
    public class RCMD_MEASURE_L
    {
        public string LOADPORT_ID { get; set; }

        public RCMD_MEASURE_L()
        {
    ...
    {
        public bool RunDecode(RemoteControlEventRemoteCommandArgs e, out RCMD_MEASURE_L rcmdInfo)
        {
            bool bDataCheckOK = true;
            rcmdInfo = new RCMD_MEASURE_L();
