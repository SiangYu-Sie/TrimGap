...
{
    public class RCMD_RELEASE_L
    {
        public string LOADPORT_ID { get; set; }

        public RCMD_RELEASE_L()
        {
    ...
    {
        public bool RunDecode(RemoteControlEventRemoteCommandArgs e, out RCMD_RELEASE_L rcmdInfo)
        {
            bool bDataCheckOK = true;
            rcmdInfo = new RCMD_RELEASE_L();
