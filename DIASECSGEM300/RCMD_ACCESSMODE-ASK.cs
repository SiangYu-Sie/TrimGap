...
{
    public class RCMD_ACCESSMODE_ASK
    {
        public string LOADPORT_ID { get; set; }

        public RCMD_ACCESSMODE_ASK()
        {
    ...
    {
        public bool RunDecode(RemoteControlEventRemoteCommandArgs e, out RCMD_ACCESSMODE_ASK rcmdInfo)
        {
            bool bDataCheckOK = true;
            rcmdInfo = new RCMD_ACCESSMODE_ASK();
