...
namespace FSSCommon
{
    ...
    public class FlyingSpotScanner
    {
        ...
        public void Open(string ipAddress, bool useRawDataMode = false)
        {
            ...
            Conn.SetOutputDataFormatMode(useRawDataMode ? Lib.Output_Data_Format_Raw :
                Lib.Output_Data_Format_Double);
        ...
        public void Run(Int32 programHandle)
        {
            ...
            Plugin.Exec((CmdID)CHRLibPlugin.CmdID_Flying_Spot_Exec, ScanProgramCallback,
                  programHandle);
            IsScanning = true;
        }
