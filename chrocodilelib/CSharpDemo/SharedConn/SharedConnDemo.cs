...
namespace TCHRLibSharedConn
{
    public partial class SharedConn : Form
    {
        ...
        //callback functions
        private AsynchronousConnection.ResponseAndUpdateCallback GenCmdCb;  //command callback
        private AsynchronousConnection.DataCallback SampleCB;     //data callback

        private void Init()
        {
            //Callback function for asynchronous command response
            GenCmdCb = new AsynchronousConnection.ResponseAndUpdateCallback(GenCmdCbFct);
            //Callback function for data samples
        ...
        private void ReceiveSample(AsyncDataStatus status, Data _oData)
        {
