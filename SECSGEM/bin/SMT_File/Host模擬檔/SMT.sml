...
S2F38: S2F38
.
S2F41_MAGAZINE_MOVEIN: S2F41
<L[2]
	<A[15]"MAGAZINE_MOVEIN">
	<L[3]
		<L[2]
			<A[6]"LOT_ID">
			<A[10]"SD58767868">
		...
		>
		<L[2]
			<A[22]"MAGAZINE_MOVEIN_STATUS">
			<A[4]"PASS">
		>
	>
>
.
S2F41_BOAT_MOVEIN: S2F41
<L[2]
	<A[11]"BOAT_MOVEIN">
	<L[2]
		<L[2]
			<A[12]"BOAT_BARCODE">
			<A[23]"67.5x75-T-014-014-N0191">
		>
		<L[2]
			<A[18]"BOAT_MOVEIN_STATUS">
			<A[4]"PASS">
		>
	>
>
.
S2F41_PASS1MAGAZINE_MOVEIN: S2F41
<L[2]
	<A[20]"PASS1MAGAZINE_MOVEIN">
	<L[2]
		<L[2]
			<A[16]"PASS1MAGAZINE_ID">
			<A[9]"MA12965WE">
		>
		<L[2]
			<A[27]"PASS1MAGAZINE_MOVEIN_STATUS">
			<A[4]"PASS">
		>
	>
>
.
S2F41_PASS2MAGAZINE_MOVEIN: S2F41
<L[2]
	<A[20]"PASS2MAGAZINE_MOVEIN">
	<L[2]
		<L[2]
			<A[16]"PASS2MAGAZINE_ID">
			<A[9]"MA12965WE">
		>
		<L[2]
			<A[27]"PASS2MAGAZINE_MOVEIN_STATUS">
			<A[4]"PASS">
		>
	>
>
.
S2F41_NGMAGAZINE_MOVEIN: S2F41
<L[2]
	<A[17]"NGMAGAZINE_MOVEIN">
	<L[2]
		<L[2]
			<A[13]"NGMAGAZINE_ID">
			<A[9]"MA12965WE">
		>
		<L[2]
			<A[24]"NGMAGAZINE_MOVEIN_STATUS">
			<A[4]"PASS">
		>
	>
>
.
S2F41_EMPTYMAGAZINE_MOVEIN: S2F41
<L[2]
	<A[20]"EMPTYMAGAZINE_MOVEIN">
	<L[2]
		<L[2]
			<A[16]"EMPTYMAGAZINE_ID">
			<A[9]"MA12965WE">
		>
		<L[2]
			<A[27]"EMPTYMAGAZINE_MOVEIN_STATUS">
			<A[4]"PASS">
		>
	>
>
.
S2F41_PASS1MAGAZINE_MOVEOUT: S2F41
<L[2]
	<A[21]"PASS1MAGAZINE_MOVEOUT">
	<L[2]
		<L[2]
			<A[16]"PASS1MAGAZINE_ID">
			<A[9]"MA12965WE">
		>
		<L[2]
			<A[28]"PASS1MAGAZINE_MOVEOUT_STATUS">
			<A[4]"PASS">
		>
	>
>
.
S2F41_PASS2MAGAZINE_MOVEOUT: S2F41
<L[2]
	<A[21]"PASS2MAGAZINE_MOVEOUT">
	<L[2]
		<L[2]
			<A[16]"PASS2MAGAZINE_ID">
			<A[9]"MA12965WE">
		>
		<L[2]
			<A[28]"PASS2MAGAZINE_MOVEOUT_STATUS">
			<A[4]"PASS">
		>
	>
>
.
S2F41_NGMAGAZINE_MOVEOUT: S2F41
<L[2]
	<A[18]"NGMAGAZINE_MOVEOUT">
	<L[2]
		<L[2]
			<A[13]"NGMAGAZINE_ID">
			<A[9]"MA12965WE">
		>
		<L[2]
			<A[25]"NGMAGAZINE_MOVEOUT_STATUS">
			<A[4]"PASS">
		>
	>
>
.
S2F41_BOAT_ASSING_NGBOAT: S2F41
<L[2]
	<A[18]"BOAT_ASSING_NGBOAT">
	<L[2]
		<L[2]
			<A[26]"BOAT_ASSING_NGBOAT_BARCODE">
			<A[23]"67.5x75-T-014-014-N0191">
		>
		<L[2]
			<A[25]"BOAT_ASSING_NGBOAT_STATUS">
			<A[4]"PASS">
		>
	>
>
...
>
.
S2F41_EQUIPMENT_START: S2F41
<L[2]
	<A[29]"EQUIPMENT_OPERATIONAL_COMMAND">
	<L[1]
		<L[2]
			<A[27]"EQUIPMENT_OPERATIONAL_STATE">
			<A[5]"START">
		>
	>
>
.
S2F41_EQUIPMENT_STOP: S2F41
<L[2]
	<A[29]"EQUIPMENT_OPERATIONAL_COMMAND">
	<L[1]
		<L[2]
...
>
.
S2F41_EQUIPMENT_ENDLOT: S2F41
<L[2]
	<A[24]"EQUIPMENT_ENDLOT_COMMAND">
	<L[1]
		<L[2]
			<A[16]"EQUIPMENT_ENDLOT">
			<A[6]"ENDLOT">
		>
	>
>
.
S2F41_EMPTYBOAT_RELEASE: S2F41
<L[2]
	<A[17]"EMPTYBOAT_RELEASE">
	<L[2]
		<L[2]
			<A[17]"EMPTYBOAT_BARCODE">
			<A[23]"67.5x75-T-014-014-N0191">
		>
		<L[2]
			<A[24]"EMPTYBOAT_RELEASE_STATUS">
			<A[4]"PASS">
		>
	>
>
.
S2F41_EQUIPMENT_STARTRUN: S2F41
<L[2]
	<A[18]"EQUIPMENT_STARTRUN">
	<L[1]
		<L[2]
			<A[25]"EQUIPMENT_STARTRUN_STATUS">
			<A[4]"PASS">
		>
	>
>
