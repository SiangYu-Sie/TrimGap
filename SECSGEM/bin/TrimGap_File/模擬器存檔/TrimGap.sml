...
>
.
S2F41_ACCESSMODE-CHANGE: S2F41
<L[2]
	<A[17]"ACCESSMODE-CHANGE">
	<L[2]
		<L[2]
			<A[11]"LOADPORT-ID">
			<A[1]"1">
...
>
.
S2F41_PORT_TRANSFERSTATUS_ASK: S2F41
<L[2]
	<A[23]"PORT-TRANSFERSTATUS-ASK">
	<L[1]
		<L[2]
			<A[11]"LOADPORT-ID">
			<A[1]"1">
...
<L[2]
	...
	<A[20]"ThisisatestrecipePP3">
>
.
S7F3_SendSubfolderPP(PP1): S7F3 W
<L[2]
	<A[10]"PPData\PP1">
	<A[29]"ThisisatestsubforderrecipePP1">
>
.
S7F3_SendSubfolderPP(PP2): S7F3 W
<L[2]
	<A[10]"PPData\PP2">
	<A[29]"ThisisatestsubforderrecipePP2">
>
.
...
<L[2]
	...
	<A[29]"ThisisatestsubforderrecipePP3">
>
.
S7F3_SendPP(PP1_PPIDWithExtName): S7F3 W
<L[2]
	<A[7]"PP1.pjb">
	<A[28]"Thisisaunformattedtestrecipe">
>
.
