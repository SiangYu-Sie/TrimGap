            ...
            if (e.ProgressPercentage == 0)
            {
                try
                {
                    ...
                    if (Wafertype == 1)
                    {
                        ...
                        tmp[1] = SignalPlotData.resultdata[1].ToString("f1");// + fram.Analysis.Offset1StepW;     //W1
